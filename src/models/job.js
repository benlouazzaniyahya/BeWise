...
const deleteByLesson = (lessonId) => run('DELETE FROM gen_jobs WHERE lesson_id = ?', lessonId);
...
module.exports = { create, findById, listByLesson, countActiveByLesson, setRunning, setDone, setFailed, deleteByLesson, sweepStale };